...
def sample_ingredient(user, name = 'Cinamon'):
    '''Create and return a sample ingretient'''
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id = res.data['id'])
        tags = recipe.tags.all()  # all tags for this recipe
...
class RecipeImageUploadsTests(TestCase):
    ...
    def tearDown(self):  # method will run after all tests
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix = '.jpg') as ntf:
            ...
            ntf.seek(0)  # back to the begining of the file
